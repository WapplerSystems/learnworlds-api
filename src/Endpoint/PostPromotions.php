...
class PostPromotions extends BaseEndpoint
{
    /**
     ...
     * }
     */
    public function __construct(?V2PromotionsPostBody $requestBody = null, array $headerParameters = [])
    {
    ...
    {
        if ($this->body instanceof V2PromotionsPostBody) {
     ...
     *
     *
     * @return null|V2PromotionsPostResponse201
     */
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (201 === $status && str_contains($contentType, 'application/json'))) {
            return $serializer->deserialize($body, V2PromotionsPostResponse201::class, 'json');
        }
    }
