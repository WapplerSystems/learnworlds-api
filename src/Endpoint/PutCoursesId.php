...
class PutCoursesId extends BaseEndpoint
{
    protected $id;
     ...
     * }
     */
    public function __construct(string $id, ?V2CoursesIdPutBody $requestBody = null, array $headerParameters = [])
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof V2CoursesIdPutBody) {
