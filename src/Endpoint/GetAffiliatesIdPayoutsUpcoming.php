...
class GetAffiliatesIdPayoutsUpcoming extends BaseEndpoint
{
    protected $id;
     ...
     *
     *
     * @return null|V2AffiliatesIdPayoutsUpcomingGetResponse200
     */
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && str_contains($contentType, 'application/json'))) {
            return $serializer->deserialize($body, V2AffiliatesIdPayoutsUpcomingGetResponse200::class, 'json');
        }
    }
