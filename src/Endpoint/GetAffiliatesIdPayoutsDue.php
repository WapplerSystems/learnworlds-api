...
class GetAffiliatesIdPayoutsDue extends BaseEndpoint
{
    protected $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/v2/affiliates/{id}/payouts/due');
    }
     ...
     *
     *
     * @return null|V2AffiliatesIdPayoutsDueGetResponse200
     */
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && str_contains($contentType, 'application/json'))) {
            return $serializer->deserialize($body, V2AffiliatesIdPayoutsDueGetResponse200::class, 'json');
        }
    }
