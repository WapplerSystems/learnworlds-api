...
class PutUsersIdTags extends BaseEndpoint
{
    protected $id;
     ...
     * }
     */
    public function __construct(string $id, ?V2UsersIdTagsPutBody $requestBody = null, array $headerParameters = [])
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof V2UsersIdTagsPutBody) {
