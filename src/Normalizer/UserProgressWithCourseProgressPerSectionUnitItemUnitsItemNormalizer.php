...
class UserProgressWithCourseProgressPerSectionUnitItemUnitsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'WapplerSystems\\LearnWorldsApi\\Model\\UserProgressWithCourseProgressPerSectionUnitItemUnitsItem';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'WapplerSystems\\LearnWorldsApi\\Model\\UserProgressWithCourseProgressPerSectionUnitItemUnitsItem';
    }
