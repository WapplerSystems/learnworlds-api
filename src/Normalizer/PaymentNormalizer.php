...
class PaymentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'WapplerSystems\\LearnWorldsApi\\Model\\Payment';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'WapplerSystems\\LearnWorldsApi\\Model\\Payment';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (array_key_exists('product', $data)) {
            $object->setProduct($this->denormalizer->denormalize($data['product'], PaymentProduct::class, 'json', $context));
            unset($data['product']);
        }
        ...
        if (array_key_exists('instructors', $data)) {
            ...
            foreach ($data['instructors'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, PaymentInstructorsItem::class, 'json', $context);
            }
        ...
        if (array_key_exists('affiliate', $data)) {
            $object->setAffiliate($this->denormalizer->denormalize($data['affiliate'], PaymentAffiliate::class, 'json', $context));
