...
class CouponNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'WapplerSystems\\LearnWorldsApi\\Model\\Coupon';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'WapplerSystems\\LearnWorldsApi\\Model\\Coupon';
    }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->isInitialized('bulk') && null !== $object->getBulk()) {
            $data['bulk'] = $object->getBulk();
        }
