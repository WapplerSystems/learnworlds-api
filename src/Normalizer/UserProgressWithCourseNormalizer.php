...
class UserProgressWithCourseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'WapplerSystems\\LearnWorldsApi\\Model\\UserProgressWithCourse';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'WapplerSystems\\LearnWorldsApi\\Model\\UserProgressWithCourse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new UserProgressWithCourse();
        ...
        if (array_key_exists('progress_per_section_unit', $data)) {
            ...
            foreach ($data['progress_per_section_unit'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, UserProgressWithCourseProgressPerSectionUnitItem::class, 'json', $context);
            }
