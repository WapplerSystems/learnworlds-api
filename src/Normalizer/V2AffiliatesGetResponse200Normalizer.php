...
class V2AffiliatesGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'WapplerSystems\\LearnWorldsApi\\Model\\V2AffiliatesGetResponse200';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'WapplerSystems\\LearnWorldsApi\\Model\\V2AffiliatesGetResponse200';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new V2AffiliatesGetResponse200();
        ...
        if (array_key_exists('data', $data)) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, Affiliate::class, 'json', $context);
            }
