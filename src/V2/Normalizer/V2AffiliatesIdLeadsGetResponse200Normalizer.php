...
class V2AffiliatesIdLeadsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof V2AffiliatesIdLeadsGetResponse200;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new V2AffiliatesIdLeadsGetResponse200();
    ...
    {
        return [V2AffiliatesIdLeadsGetResponse200::class => false];
    }
}
