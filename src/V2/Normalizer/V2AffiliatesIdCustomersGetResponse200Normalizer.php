...
class V2AffiliatesIdCustomersGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof V2AffiliatesIdCustomersGetResponse200;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new V2AffiliatesIdCustomersGetResponse200();
    ...
    {
        return [V2AffiliatesIdCustomersGetResponse200::class => false];
    }
}
