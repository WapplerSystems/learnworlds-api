...
class Response422Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\Response422';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \WapplerSystems\LearnWorldsApi\V2\Model\Response422();
        ...
        if (\array_key_exists('errors', $data)) {
            $object->setErrors($this->denormalizer->denormalize($data['errors'], 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\Response422Errors', 'json', $context));
            unset($data['errors']);
        }
