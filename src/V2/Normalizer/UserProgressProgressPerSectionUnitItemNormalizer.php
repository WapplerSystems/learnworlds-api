...
class UserProgressProgressPerSectionUnitItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \WapplerSystems\LearnWorldsApi\V2\Model\UserProgressProgressPerSectionUnitItem();
        ...
        if (\array_key_exists('units', $data)) {
            ...
            foreach ($data['units'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\UserProgressProgressPerSectionUnitItemUnitsItem', 'json', $context);
            }
