...
class V2AffiliatesIdPaymentsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof V2AffiliatesIdPaymentsGetResponse200;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new V2AffiliatesIdPaymentsGetResponse200();
    ...
    {
        return [V2AffiliatesIdPaymentsGetResponse200::class => false];
    }
}
