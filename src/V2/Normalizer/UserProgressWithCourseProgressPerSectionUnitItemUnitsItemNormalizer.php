...
class UserProgressWithCourseProgressPerSectionUnitItemUnitsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\UserProgressWithCourseProgressPerSectionUnitItemUnitsItem';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\UserProgressWithCourseProgressPerSectionUnitItemUnitsItem';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \WapplerSystems\LearnWorldsApi\V2\Model\UserProgressWithCourseProgressPerSectionUnitItemUnitsItem();
