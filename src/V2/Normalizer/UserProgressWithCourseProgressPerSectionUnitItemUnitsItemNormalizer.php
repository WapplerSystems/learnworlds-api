...
class UserProgressWithCourseProgressPerSectionUnitItemUnitsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof UserProgressWithCourseProgressPerSectionUnitItemUnitsItem;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new UserProgressWithCourseProgressPerSectionUnitItemUnitsItem();
    ...
    {
        return [UserProgressWithCourseProgressPerSectionUnitItemUnitsItem::class => false];
    }
}
