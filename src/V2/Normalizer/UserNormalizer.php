...
class UserNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\User';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\User';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \WapplerSystems\LearnWorldsApi\V2\Model\User();
        ...
        if (\array_key_exists('role', $data)) {
            $object->setRole($this->denormalizer->denormalize($data['role'], 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\UserRole', 'json', $context));
            unset($data['role']);
        }
        ...
        if (\array_key_exists('fields', $data)) {
            $object->setFields($this->denormalizer->denormalize($data['fields'], 'WapplerSystems\\LearnWorldsApi\\V2\\Model\\UserFields', 'json', $context));
            unset($data['fields']);
        }
